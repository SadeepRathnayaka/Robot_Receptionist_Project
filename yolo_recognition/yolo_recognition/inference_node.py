...
class CameraSubscriber(Node):
    def __init__(self):
        ...
        self.array_pub_ = self.create_publisher(PersonArray, '/visual_dynamic_obs_array', 1)
    ...
    def camera_callback(self, msg):
        ...
        # array to store dynamic obstacles
        dynamic_obs_array = PersonArray()
        dynamic_obs_array.header.frame_id = "rplidar_link"
        dynamic_obs_array.header.stamp = self.get_clock().now().to_msg()
        ...
        self.array_pub_.publish(dynamic_obs_array)
